...
| `framework/review_campaign.sh <campaign>` | reads a campaign before it runs and reports what would waste a machine or a budget; `framework/review_campaign_prompt.md` is what it asks |
